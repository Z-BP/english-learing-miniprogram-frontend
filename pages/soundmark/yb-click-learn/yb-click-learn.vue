<template>
	<view class="content">
		<text class="title">朗读下面文本,进行测评</text>
		<text class="text">{{chapter}}</text>
...
<script setup lang="ts">
	...
	// 前端生成 webSocketUrl
	const APP_ID = "bcc40608";
	const API_KEY = "25d861eb12c27027b32a826150d857bf";
	const API_SECRET = "MDgyOWFlNGY5MTIzYmYwY2UwNTM0MTAx";
